...
`label`::
  ...
  link:../../extending-ui/language-strings/[chapter on language]).
`displayParams`::
...
{{% notice info %}}
You can find additional technical information on Subpanels' implementation in a file
on your SuiteCRM installation: 
link:https://github.com/SuiteCRM/SuiteCRM/blob/master/include/SubPanel/subpanels.txt[include/SubPanel/subpanels.txt]
{{% /notice %}}
