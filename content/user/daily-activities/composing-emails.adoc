...
the *Emails* module. See link:../../getting-started/managing-your-profile/#_personal_email_account_settings[Personal Email Settings]
...
you can edit your link:../../getting-started/managing-your-profile/#_personal_email_account_settings[user profile email settings].
...
{{% notice note %}}If you have opted to use an external email client in your link:../../getting-started/managing-your-profile/#_personal_email_account_settings[user profile email settings], clicking an
...
* *Email Template:* Select a template if required. See link:../../marketing-outreach/email-templates[Email Templates] for more information
...
link:../../getting-started/managing-your-profile/#_user_profile_email_settings[user profile email settings], this will appear
...
a *SuiteCRM Document* to the email. Search for the required Document in the popup and click **SELECT** to attach it.
...
or begin typing the name into the field and select the required record from the auto-complete list. Click the **OK** button.
...
=== Automated Mail Import

The Check Inbound Mailboxes scheduler job is responsible for automatically importing email from group email accounts
...
Read more about this scheduler and how to configure it in link:../../../admin/administration-panel/emails/automatic-email-importing/[Automatic Email Importing].
