...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.0.2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.0.2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.0.1.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.0.1.tar.gz[*Source
code* (tar.gz)]
