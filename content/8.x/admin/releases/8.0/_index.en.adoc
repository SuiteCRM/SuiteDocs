...
* https://github.com/SuiteCRM/SuiteCRM-Core[Github]
...
If you want to get involved or submit a Fix, fork the repo and when ready please link:https://github.com/SuiteCRM/SuiteCRM-Core/pulls[Submit An PR] - More detail for developers can be found link:https://docs.suitecrm.com/8.x/developer/development-install-guide/[here].
...
* PR: https://github.com/SuiteCRM/SuiteCRM/pull/9087[9087] - Fix #9087 - Allow changing text colors when composing an email
...
* Fix https://github.com/SuiteCRM/SuiteCRM-Core/issues/42[42] - [8-Subpanels-Bug] Activities & History subpanels do not show create actions
* Fix https://github.com/SuiteCRM/SuiteCRM-Core/issues/41[41] - SuiteCRM 8 install - Port not properly set
...
* https://github.com/SuiteCRM/SuiteCRM-Core/archive/refs/tags/v8.0.0-beta.3.zip[*Source code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM-Core/archive/refs/tags/v8.0.0-beta.3.tar.gz[*Source code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM-Core/archive/refs/tags/v8.0.0-beta.2.zip[*Source code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM-Core/archive/refs/tags/v8.0.0-beta.2.tar.gz[*Source code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM-Core/archive/refs/tags/v8.0.0-beta.1.zip[*Source code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM-Core/archive/refs/tags/v8.0.0-beta.1.tar.gz[*Source code* (tar.gz)]
...
If you want to get involved or submit a Fix, fork the repo and when ready please link:https://github.com/SuiteCRM/SuiteCRM-Core/pulls[Submit An PR] - More detail for developers will be coming soon so stay tuned.
