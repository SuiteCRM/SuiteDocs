...
addition to rolling back changes. https://git-scm.com/[Git^] is the
recommended choice and is used by SuiteCRM itself.
...
link:../../core-framework/extension-framework/[Extensions] chapter for more
information.

== Use appropriate log levels

Using appropriate log levels (See the chapter on
link:../../optimization-security/logging/[Logging]) makes it easier to track
...
job queue (see the link:../../core-framework/logic-hooks/[Logic Hooks] and
link:../../extending-app/scheduled-tasks/[Scheduled Tasks] chapters).
...
link:../../core-framework/working-with-beans/[Working with beans]). There
...
Finally any custom logic (such as link:../../core-framework/logic-hooks[Logic Hooks]) which would usually be
...
.Example 17.3: Checking for the database engine
[source,php]
----
...
link:../../integration-api/entry-points/[Entry Points] chapter). These
...
.Example 17.5: Redirecting within SuiteCRM
[source,php]
