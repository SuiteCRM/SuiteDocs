...
weight: 6
aliases:
    - /developer/theme/suitepiconsfont/how_to_create_font/
---

== Requirements
'''

Pull down the Suite-P-Icon-Font repository from github - https://github.com/SuiteCRM/SuiteP-Icon-Font[click here to take you to the repository] - Then continue on to the steps provided below.
