...
* Ajuste los ajustes de la ventana de sincronización si es necesario; consulte link:/admin/administration-panel/calendar-sync/admin-setup#_sync_window_settings[Ajustes de la ventana de sincronización]
