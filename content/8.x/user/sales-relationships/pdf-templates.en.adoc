...
* Search Templates - utilise link:../../core-concepts/searching[Filters or advanced filters] in the module list view.
* link:../../core-concepts/record-management/#_exporting_records[Export] templates, for this, select the necessary records in the list.
* Editing or deleting information about several templates at once, use this link:../../core-concepts/record-management/#_mass_updating_records[Mass update].
...
* You can track changes to the entered information, to do this select the `View Change Log` button in the form of viewing. If the journal needs to change the list of controlled fields - do it by setting the *Audit* parameter on the corresponding field.
