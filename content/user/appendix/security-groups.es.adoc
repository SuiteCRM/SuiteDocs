...
Para la configuración por parte del administrador de los Grupos de Seguridad, consulte la sección link:../../../admin/administration-panel/roles-and-security-groups[Roles y Grupos de Seguridad] de la Guía de Administración.
