...
link:../../integration-api/entry-points/[Entry Points].
...
chapter on link:../../extending-ui/language-strings[Language Strings].
...
link:../../extending-app/scheduled-tasks/[Scheduled Tasks].
