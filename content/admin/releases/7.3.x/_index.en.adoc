...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3.2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3.2.tar.gz[*Source
code* (tar.gz)]
...
Download https://github.com/SuiteCRM/SuiteCRM/releases/tag/v7.3.2[here] from the SuiteCRM GitHub Repository or
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3.1.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3.1.tar.gz[*Source
code* (tar.gz)]
...
Download https://github.com/SuiteCRM/SuiteCRM/releases/tag/v7.3.1[here] from the SuiteCRM GitHub Repository or
https://suitecrm.com/download[visit the official website] to find the
appropriate upgrade.
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3.tar.gz[*Source
code* (tar.gz)]
...
Download https://github.com/SuiteCRM/SuiteCRM/releases/tag/v7.3[here] from the SuiteCRM GitHub Repository or
https://suitecrm.com/download[visit the official website] to find the
appropriate upgrade.
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3beta3.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3beta3.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3-beta.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.3-beta.tar.gz[*Source
code* (tar.gz)]
