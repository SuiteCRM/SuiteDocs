...
weight: 10
aliases:
  - /user/introduction/user-interface/navigation-elements
---
...
records/data.
* *Alerts* – This shows the number of desktop notifications you have not yet read. Click the bell icon to view and manage pending notifications. See <<Alerts>> below for details.
...
user preferences, see the link:../../getting-started/managing-your-profile[Managing Your Profile]
...
The bell icon in the top navigation bar shows a count of pending desktop notifications — alerts for upcoming Calls and Meetings that have popup reminders set.

image:66Managing_notifications.png[title="Notification Count"]

Click the bell icon to open the notification list.

image:67Managing_notifications.png[title="Notification List"]

From here you can:

* *Click a notification*: navigate directly to the related record (Call or Meeting).
* *Click the x icon*: dismiss and clear that individual notification.

If no unread notifications exist, no count is shown.

To enable or disable desktop notifications in your browser, see the link:../../getting-started/managing-your-profile/#_desktop_notifications[Desktop Notifications] setting in your profile's Advanced Tab.
