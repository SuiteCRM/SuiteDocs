...
The email compose modal allows you to send emails directly from SuiteCRM. The modal can be collapsed while navigating the app and supports rich text editing with the Squire editor.
...
image:email-compose-open.png[Compose modal opening from an email address link on a record]
...
image:variable-injector-email.png[Variable Injector panel open in the email compose body toolbar]
...
{{% notice note %}}
If a referenced field is empty or the relationship doesn't exist, the variable will be replaced with an empty string.
{{% /notice %}}
...
* Uploading files directly from your computer using *Attach Files*.
* Attaching documents from the Documents module using *Attach Documents*.
...
. Click the *Attach Documents* button in the compose modal footer.
...
image:deleted-document-attachment.png[Compose modal showing a "Document not found" attachment placeholder]
...
image:attached-file-and-document.png[Compose modal attachment area showing a document attachment icon alongside a file upload icon]

== Inserting an Email Template

To insert an email template, click the *Insert Template* button in the compose modal footer. This allows you to select from your available email templates and insert the content directly into your email body and subject.

When you select a template, any variables within the template will be parsed based on the selected Related To record.

== Sending Your Email

Once you have completed composing your email, click *Send* to send it immediately.
...
The compose modal can be maximized to provide a larger workspace for composing your email. To maximize it, click the maximize icon in the top right corner of the modal.

image:maximised-compose-modal.png[Compose modal in maximized view showing the full-width editor]

== Navigating While Composing

The compose modal can be collapsed to allow you to navigate to other records or modules while keeping your email draft open. This is useful for referencing information or attaching documents from other records without losing your email content.

To collapse the modal, click the minimize icon in the top right corner of the compose modal or click the modal header.

image:minimized-modal.png[Compose modal collapsed to a bar at the bottom of the screen]

== Opening Multiple Compose Modals

You can open multiple compose modals at the same time, allowing you to work on several emails simultaneously. Each compose modal will function independently, and you can switch between them as needed.

image:multiple-open-modals.png[Multiple compose modals open simultaneously at the bottom of the screen]
