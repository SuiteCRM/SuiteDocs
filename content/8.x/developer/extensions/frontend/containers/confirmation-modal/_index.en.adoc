...
* **Record logic** — logic actions like `updateValues` and `autofillFromRelate` can show a confirmation modal before applying changes

For the **List Confirmation Modal** — a variant that displays a searchable, paginated table of records — see link:./confirmation-list-modal[Confirmation List Modal].
