...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.4.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.4.tar.gz[*Source
code* (tar.gz)]
...
Download https://github.com/SuiteCRM/SuiteCRM/releases/tag/v7.2.4[here] from the SuiteCRM GitHub Repository or
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.3.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.3.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.1.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.1.tar.gz[*Source
code* (tar.gz)]
...
Download https://github.com/SuiteCRM/SuiteCRM/releases/tag/v7.2.1[here] or https://suitecrm.com/download[click here] to find the
appropriate upgrade.
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2beta3.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2beta3.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2beta2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2beta2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2beta.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.2beta.tar.gz[*Source
code* (tar.gz)]
