...
Select the campaign you wish to create: *Newsletter*, *Email*, link:../surveys[Survey] or *Non-email based Campaign*. Non-email based campaigns allow you to keep a record of any campaigns that are run outwith *SuiteCRM* (e.g. a telesales or radio based campaign).
...
To remove a target list, click **rem**
...
Click **DELETE TEST ENTRIES** to remove any entries on the campaign status page that have been generated during testing with a 'test' type link:../target-lists[target list].
...
link:../targets[Lead], link:../contacts[Contact] or link:../targets[Target] record in *SuiteCRM*
...
Once you are happy with the appearance of your web form click **SAVE WEB FORM**
