...
* https://github.com/SuiteCRM/SuiteCRM-Core/releases/tag/v8.7.1[GitHub - Download]
...
* PR: https://github.com/SuiteCRM/SuiteCRM-Core/pull/417[417] - Fix https://github.com/SuiteCRM/SuiteCRM-Core/issues/168[#168] - Contact Email Address not showing in Subpanels
...
* https://github.com/SuiteCRM/SuiteCRM-Core/releases/tag/v8.7.0[GitHub - Download]
* link:../../installation-guide/downloading-installing[SuiteCRM 8 Install Guide]
* link:../../upgrading[SuiteCRM 8 Upgrade Guide]
* link:../../legacy-migration/8.7.0-legacy-migration/[SuiteCRM 8 Migration from SuiteCRM 7]
...
* link:https://github.com/SuiteCRM/SuiteCRM-Core/issues/62[Fix #62] Add 'show_fullname' option
* link:https://github.com/SuiteCRM/SuiteCRM-Core/issues/473[Fix #473]  Document filename(file) not showing in Subpanels
* link:https://github.com/SuiteCRM/SuiteCRM-Core/issues/436[Fix #436] - Update log configuration
* link:https://github.com/SuiteCRM/SuiteCRM-Core/issues/504[Fix #504] - Fix required validation in Email line items field
