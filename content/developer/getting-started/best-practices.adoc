...
link:../extension-framework/[Extensions] chapter for more
information.

== Use appropriate log levels

Using appropriate log levels (See the chapter on
link:../logging/[Logging]) makes it easier to track
...
job queue (see the link:../logic-hooks/[Logic Hooks] and
link:../scheduled-tasks/[Scheduled Tasks] chapters).
...
link:../working-with-beans/[Working with beans]). There
...
link:../entry-points/[Entry Points] chapter). These
