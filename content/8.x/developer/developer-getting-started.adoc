...
. Download the dev package from github, e.g.: `SuiteCRM-8.3.0-dev.zip`, see the dev package in the link:https://github.com/SuiteCRM/SuiteCRM-Core/releases/latest[Latest GitHub Release]
...
. Setup the frontend extension using the link:./extensions/frontend/older/8x-fe-extensions-getting-started[Getting started with frontend extension development]
