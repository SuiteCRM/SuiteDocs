...
See the chapter on link:../../extending-ui/language-strings/[Language Strings]
...
link:../../core-framework/vardefs/[Vardefs] chapter for more information
...
link:../../core-framework/logic-hooks/[Logic Hooks] chapter for more
