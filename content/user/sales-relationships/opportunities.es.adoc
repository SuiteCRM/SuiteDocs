...
weight: 30
aliases:
  - /es/user/core-modules/opportunities
---
...
Una Oportunidad es un cliente potencial de Ventas cualificado con una probabilidad razonable de
que se pueda hacer negocio con su empresa. Se ha establecido que
tiene capacidad de compra y ha entrado en el ciclo de compra. Este
módulo le permite seguir sus Oportunidades a lo largo del Pipeline
de Ventas hasta que el negocio se marca como "Cerrado Perdido" o "Cerrado Ganado".
...
{{% notice tip %}}
SuiteCRM incluye una función de Mapas integrada. Se puede consultar un panel de mapa con la dirección de la cuenta asociada en los registros de Oportunidad. Consulte link:../../integrations/maps[Mapas] para más información.
{{% /notice %}}
