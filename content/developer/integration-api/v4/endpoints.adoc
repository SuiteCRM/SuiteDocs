...
weight: 40
aliases:
    - /developer/api/api-v4.1-methods/
---

= API v4.1 Methods

{{% notice warning %}}
This page documents the legacy v4.1 API methods. New integrations should use the link:../../v8/[V8 API].
{{% /notice %}}
...
|=======================================================================
|Name |Type |Desc
|error |array |An array containing error details. Present on failure.

|error[number] |int |The error number. `0` indicates success.

|error[name] |string |A short name for the error (e.g. `invalid_login`).

|error[description] |string |A human-readable description of the error.
|=======================================================================
...
|=======================================================
|Number |Meaning
|10 |Invalid login credentials or expired session
|11 |Invalid session
|20 |No module specified
|1000 |Unknown error
|=======================================================
...
|modules[][favorite_enabled] |bool |Always empty. See note at top of page.
...
|favorites |bool |Unused. See note at top of page.
|=======================================================================
...
|result[][id] |string |The id of the tracker row for this viewing
...
|module_fields[calculated] |string |Always empty. See note at top of page.
...
|name_value_list[] |array |A name value pair for each field value.

|name_value_list[][name] |string |The name of the field.

|name_value_list[][value] |string |The value for the field.
|=======================================================================
