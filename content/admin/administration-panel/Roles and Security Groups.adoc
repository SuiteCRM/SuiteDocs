...
please see an link:/user/appendix/security-groups/#_example_a_typical_hierarchy_setup[Example of a Typical Setup] and this
https://www.youtube.com/watch?v=B7u--perz2A[Introduction Video^]
{{% /notice %}}
