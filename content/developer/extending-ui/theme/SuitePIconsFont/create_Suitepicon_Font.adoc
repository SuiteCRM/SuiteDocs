...
weight: 2
aliases:
    - /developer/theme/suitepiconsfont/create_suitepicon_font/
---
...
These files are available online in the https://github.com/SuiteCRM/SuiteP-Icon-Font[SuiteP Icon Font GitHub repository]
