...
{{% notice warning %}}
The module name under the `module` key must be the **frontend module name** (e.g. `Contacts`, `AOS_Quotes`), not the legacy internal name. This is the same name you see in the URL when viewing the module in SuiteCRM 8.
{{% /notice %}}
