...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.8.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.8.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.7.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.7.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.6.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.6.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.5.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.5.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.4.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.4.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.3.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.3.tar.gz[*Source
code* (tar.gz)]
...
* Shortcut return when attempting to index on the save of AOD_Index
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.1.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.1.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1RC2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1RC2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1RC.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1RC.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1beta2.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1beta2.tar.gz[*Source
code* (tar.gz)]
...
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1beta.zip[*Source
code* (zip)]
* https://github.com/SuiteCRM/SuiteCRM/archive/v7.1beta.tar.gz[*Source
code* (tar.gz)]
