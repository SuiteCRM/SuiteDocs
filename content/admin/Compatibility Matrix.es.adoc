...
| IE | 11 (modo de compatibilidad no soportado)
...
| PHP | 5.6, 7.0, 7.1, 7.2, +
7.3 (a partir de SuiteCRM 7.11.5) +
7.4 (a partir de SuiteCRM 7.11.19)
...
| MySQL |5.5, 5.6, 5.7 +
8 (a partir de SuiteCRM 7.11.16)
...
7.3 (a partir de SuiteCRM 7.10.17) +
7.4 (a partir de SuiteCRM 7.10.30)
...
| MySQL |5.5, 5.6, 5.7 +
8 (a partir de SuiteCRM 7.10.28)
...
|IE |9, 10, 11 (modo de compatibilidad no soportado)
