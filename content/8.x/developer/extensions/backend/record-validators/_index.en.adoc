---
title: "Record Validators"
weight: 30
---

== 1. Introduction

Record Validators are backend classes that run custom validation logic before record save operations. They allow you to enforce business rules, restrict access, or reject invalid data at the API level before the record is persisted.
...
| `getModes()`
| `string[]`
| The operation modes where this validator should run. See link:./#_32_modes[Modes].
