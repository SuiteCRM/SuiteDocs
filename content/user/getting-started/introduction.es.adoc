...
{{% notice note %}}
Esta guía cubre SuiteCRM 7.x. Si no está seguro de qué versión utiliza su organización, haga clic en **su nombre** en la sección superior derecha del menú de navegación y seleccione **Acerca de**. El número de versión se muestra debajo del logotipo de SuiteCRM.
{{% /notice %}}
...
* *Esta guía no cubre la administración ni el desarrollo:* la configuración de usuarios, del sistema y su ampliación mediante código se tratan en la link:../../../admin/[Guía del Administrador] y la link:../../../../developer/[Guía del Desarrollador] (disponible solo en inglés).
