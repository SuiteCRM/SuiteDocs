...
For initial setup, see link:/admin/administration-panel/calendar-sync/admin-setup[Administrator Setup Guide] and link:/user/integrations/calendar-sync[User Guide].
...
See link:/user/integrations/calendar-sync[User Guide] for detailed Calendar Account creation instructions.
...
* Consult link:/user/integrations/calendar-sync[User Guide] when assisting users with calendar connections
* Reference link:/user/integrations/caldav-guide[CalDAV Provider Guide] for CalDAV-specific troubleshooting
