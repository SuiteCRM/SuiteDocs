...
So these are all translations of the same file (English, Russian):
...
link:https://github.com/SuiteCRM/SuiteDocs/blob/master/layouts/shortcodes/ghcontributors.html[defined in our own site^]), 
