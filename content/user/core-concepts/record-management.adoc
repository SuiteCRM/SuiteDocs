...
weight: 50
aliases:
  - /user/introduction/user-interface/record-management
---
...
In-line editing lets you change field values directly from the List View or Detail View without opening the full Edit View.

{{% notice note %}}
In-line editing can be enabled or disabled for List View and Detail View separately by a system administrator via System Settings.
{{% /notice %}}

image:186In-line_editing.png[title="In-line Editing"]

=== List View

Double-click on a field in the List View where the pencil icon is shown to edit it in place.

image:60ListView_editing.png[title="List View In-line Editing"]

Once you have made the required change, press Return or click the tick icon to save. If you navigate away with unsaved changes, a prompt will warn you before discarding them.

=== Detail View

Double-click on a field in the Detail View where the pencil icon is shown to edit it in place.
