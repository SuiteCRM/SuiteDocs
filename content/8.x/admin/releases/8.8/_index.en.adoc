...
* You are now able to configure an Outbound Email Account with OAuth. To see more information on setup please see link:../../../../admin/administration-panel/emails/inboundemail-oauth-howto[here.]
...
* https://github.com/SuiteCRM/SuiteCRM-Core/releases/tag/v8.8.0[GitHub - Download]
* link:../../installation-guide/downloading-installing[SuiteCRM 8 Install Guide]
* link:../../upgrading[SuiteCRM 8 Upgrade Guide]
...
* Fixed: Subpanel not showing correctly on first load: https://github.com/SuiteCRM/SuiteCRM-Core/issues/511[#511]
* Fixed: Error field "amount" - SuiteCRM v. 8.5.1: https://github.com/SuiteCRM/SuiteCRM-Core/issues/478[#478]
* Fixed: Reorder modules from User profile does not change the order in navigation bar: https://github.com/SuiteCRM/SuiteCRM-Core/issues/585[#585]
* Fixed: Update scripts deletes files with no warning: https://github.com/SuiteCRM/SuiteCRM-Core/issues/475[#475]
* Fixed: Special character in database password creates issues: https://github.com/SuiteCRM/SuiteCRM-Core/issues/553[#533]
* Fixed: $addr creating unnecessary logs: https://github.com/SuiteCRM/SuiteCRM-Core/issues/577[#577]
* Fixed: Error on Email Detail View: https://github.com/SuiteCRM/SuiteCRM-Core/issues/537[#537]
* Fixed: Accented character (diacritic) displayed incorrectly: https://github.com/SuiteCRM/SuiteCRM-Core/issues/542[#542]
* Fixed: Accented letters displayed incorrectly: https://github.com/SuiteCRM/SuiteCRM-Core/issues/583[#583]
* Fixed: TextArea areas show data in html encoded: https://github.com/SuiteCRM/SuiteCRM-Core/issues/589[#589]
* Fixed: Views Incorrectly Encode UTF Characters as HTML Entities: https://github.com/SuiteCRM/SuiteCRM-Core/issues/274[#274]
* Fixed: Bug with the number field in case filters: https://github.com/SuiteCRM/SuiteCRM-Core/issues/572[#572]
* Fixed: Checkbox taking a while to respond with large data set: https://github.com/SuiteCRM/SuiteCRM-Core/issues/597[#597]
* Fixed: Update New Accounts per Month Chart: https://github.com/SuiteCRM/SuiteCRM-Core/issues/75[#75]
