...
*SuiteCRM/SuiteCRM* and base branch is `hotfix`.
For SuiteCRM 8 ensure that the base fork is
*SuiteCRM/SuiteCRM-Core* and the base branch is `hotfix`.
...
If you have not signed our https://cla.suitecrm.com/SuiteCRM/SuiteCRM[CLA] (Contributor License Agreement) then your Pull Request will fail a check
