...
* Review link:/user/integrations/calendar-sync[User Guide] to understand the user experience
* See link:/user/integrations/caldav-guide[CalDAV Provider Guide] if your users will connect to CalDAV servers
